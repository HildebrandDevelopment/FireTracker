...
{
    public interface IRecurringProcessSummaryRepository : IRepositoryReadOnly<RecurringProcessSummary>
    {
        IEnumerable<RecurringProcessSummary> GetAllRecurringProcessSummaries();
    }
}
